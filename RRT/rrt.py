...
from constants import GREEN, RED, BLACK, WHITE, PURPLE, GRAY
...
class RRT:
	...
	def planning(self):
		...
		while self.keep_searching():
			...
			# Tree grows
			self.tree.grow_tree(optimization=False)
...
def main():
	...
	rrt = RRT(start_point, goal_point, MAX_NUM_NODES, MIN_NUM_NODES,
